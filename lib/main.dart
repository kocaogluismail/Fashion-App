...
import 'package:flutter_modaapp/detail.dart';
                      ...
                      InkWell(
                        onTap: (){
                          Navigator.of(context).push(
                            MaterialPageRoute(builder: (context)=>const Detay(imgPath:'assets/images/modelgrid1.jpeg')));
                        },
                        child: Hero(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              image: const DecorationImage(image: AssetImage('assets/images/modelgrid1.jpeg'),
                              fit: BoxFit.cover
                              ),
                            ),
                          ),
                      ...
                      Column(
                          children: <Widget>[
                            InkWell(
                              onTap: () {
                                Navigator.of(context).push(
                                    MaterialPageRoute(builder: (context) => const Detay(imgPath:'assets/images/modelgrid2.jpeg')));
                              },
                              child: Hero(
                          ...
                          InkWell(
                              onTap: () {
                                Navigator.of(context).push(
                                    MaterialPageRoute(builder: (context) => const Detay(imgPath:'assets/images/modelgrid3.jpeg')));
                              },
                              child: Hero(
